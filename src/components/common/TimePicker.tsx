...
/**
 * TimePickerProps - Interface for TimePicker component props
 */
 ...
 * @param props.value - Current time value
 * @param props.onChange - Handler for time change
...
export const TimePicker = ({
    ...
    /**
     * toggleOpen - Toggle the time picker dropdown
     */
    const toggleOpen = () => {
        setIsOpen(!isOpen);
    };
    ...
    /**
     * formatTime - Format time components into string
     * @param h - Hours
     * @param m - Minutes
    ...
    /**
     * handleTimeChange - Handler for time component changes
     * @param h - Hours
     * @param m - Minutes
     * @param p - Period (AM/PM)
     */
