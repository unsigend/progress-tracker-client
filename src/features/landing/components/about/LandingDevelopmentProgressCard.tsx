...
/**
 * LandingDevelopmentProgressCardProps - Interface for LandingDevelopmentProgressCard component props
 */
interface LandingDevelopmentProgressCardProps {
    item: DevProgressData;
}

/**
 * LandingDevelopmentProgressCard - Component for displaying a development progress card
 * @param props - The props for the LandingDevelopmentProgressCard component
 * @param props.item - The development progress item to display
 * @returns LandingDevelopmentProgressCard component
 */
export const LandingDevelopmentProgressCard = ({
    item,
}: LandingDevelopmentProgressCardProps) => {
    return (
