...
import { LandingDevelopmentProgressCard } from "@/features/landing/components/about/LandingDevelopmentProgressCard";

/**
 * LandingDevelopmentProgress - Component for displaying the development progress section
 * @returns LandingDevelopmentProgress component
 */
export const LandingDevelopmentProgress = () => {
            ...
            <div className="relative">
                ...
                <div className="space-y-8">
                    {visibleItems.map((item) => (
                        <LandingDevelopmentProgressCard
                            key={item.id}
                            item={item}
                        />
                    ))}
