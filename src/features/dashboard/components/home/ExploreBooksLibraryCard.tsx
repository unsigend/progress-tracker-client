...
/**
 * ExploreBooksLibraryCard - Card component for exploring the books library
 * @returns ExploreBooksLibraryCard component
 */
export const ExploreBooksLibraryCard = () => {
    return (
        <Card
            className={cn(
        ...
        >
            ...
            <div
                ...
                style={{
                    background:
                        "radial-gradient(ellipse at 20% 30%, currentColor 0%, transparent 50%)",
                }}
            />

            {/* Decorative book icons - very subtle */}
            <div className="absolute top-8 right-8 opacity-[0.02] dark:opacity-[0.04] group-hover:opacity-[0.03] dark:group-hover:opacity-[0.06] transition-opacity duration-300">
                <Library className="h-24 w-24 text-foreground" />
            </div>
            <div className="absolute bottom-12 left-4 opacity-[0.015] dark:opacity-[0.03] group-hover:opacity-[0.025] dark:group-hover:opacity-[0.05] transition-opacity duration-300">
                <BookOpen className="h-16 w-16 text-foreground rotate-12" />
            </div>
            ...
            <CardContent className="relative z-10 p-6 h-full flex flex-col">
                ...
                <div className="flex-shrink-0 mb-6">
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                        ...
                        Find your next great read and track your reading
                        journey.
                    </p>
                </div>
