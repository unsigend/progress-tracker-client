...
/**
 * useUnsetAsCompleteUserBook - Hook for unsetting a user book as complete
 * @param id - The id of the user book to unset as complete
 * @returns useMutation hook for unsetting a user book as complete
 */
export const useUnsetAsCompleteUserBook = (id: string) => {
    const queryClient = useQueryClient();
    return useMutation({
        mutationFn: async (): Promise<UserBookWithBook> => {
            const response = await ApiClient.api.userBookControllerUnsetAsComplete(id);
