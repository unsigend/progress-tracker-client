...
import { useUserBooks } from "@/features/reading/api/user-books/hooks/useUserBooks";
import { useCreateReadingRecording } from "@/features/reading/api/recordings/hooks/useCreateRecording";
import type { ReadingRecordingCreate } from "@/features/reading/api/recordings/model/model";
import { calculateUtils } from "@/lib/utils/calculate";
import { TextUtils } from "@/lib/utils/text";

/**
 * RecordingForm - Smart component for creating a new reading recording
 * Handles its own data fetching, form state, and submission logic
...
export const RecordingForm = () => {
    ...
    const { mutate: createRecording, isPending: isSubmitting } =
        useCreateReadingRecording(selectedUserBookId);
                            ...
                            <div className="space-y-2">
                                ...
                                {isLoading ? (
                                    ...
                                    <Select
                                        ...
                                        onValueChange={setSelectedUserBookId}
                                    >
                                        <SelectTrigger
                                            id="book-select"
                                            className="w-full"
