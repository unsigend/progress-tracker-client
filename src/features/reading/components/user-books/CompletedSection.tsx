 ...
 * @param props.totalCount - Total number of completed books
 * @param props.totalPages - Total pages read across all completed books
...
export const CompletedSection = ({
    ...
    const booksForGrid = completedBooks
        ...
        .map((userBook) => ({
            id: userBook.id,
            cover_url: userBook.book!.coverUrl || "",
