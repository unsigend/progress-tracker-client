...
/**
 * UserCourseDetailCard - Pure UI component for displaying user course details
 * @param props - The props for the UserCourseDetailCard component
 * @param props.userCourse - The user course with course data
 * @param props.isLoading - Whether the data is loading
 * @param props.canMarkAsComplete - Whether the user can mark the course as complete
 * @param props.onMarkAsComplete - Handler for mark as complete action
 * @param props.onDelete - Handler for delete action
 * @returns UserCourseDetailCard component
 */
export const UserCourseDetailCard = ({
    userCourse,
    isLoading = false,
    canMarkAsComplete = false,
    onMarkAsComplete,
    onDelete,
}: UserCourseDetailCardProps) => {
    const [showDeleteDialog, setShowDeleteDialog] = useState(false);
    const navigate = useNavigate();

    /**
     * handleDeleteClick - Handler for delete button click
     */
        ...
        <Card>
            ...
            <CardContent className="p-8 sm:p-10 lg:p-12">
                <div className="space-y-8 sm:space-y-10">
                    ...
                    {/* Combined Timeline and Statistics Grid */}
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 pt-4 border-t border-border/50">
                        {/* Timeline Section */}
                        <div className="space-y-4">
                            <h2 className="text-xl sm:text-2xl font-semibold text-foreground">
                                Timeline
