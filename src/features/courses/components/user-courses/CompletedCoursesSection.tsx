...
/**
 * CompletedCoursesSection - Pure UI component for displaying completed courses
 * @param props - The props for the CompletedCoursesSection component
 * @param props.completedCourses - Array of completed user courses with course data
 * @param props.isLoading - Whether the data is loading
 * @returns CompletedCoursesSection component
 */
export const CompletedCoursesSection = ({
    completedCourses,
    isLoading,
}: CompletedCoursesSectionProps) => {
    // Basic state for selected category filter
    ...
    // Map to CourseGrid format - use userCourseId directly (like reading module does)
